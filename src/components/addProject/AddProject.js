...
class AddProject extends Component {
    constructor(props) {
        super(props);
        this.state= {open : true,dropdownOpen: false, listpm : [{value:'ant',label:'ant'},{value:'aume',label:'aume'},{value:'pang',label:'pang'},{value:'ping',label:'ping'},{value:'pop',label:'pop'}],
                    ...
                    projectname:"",checkedcolor:'',pm:[],
                    unchecked:[false,false,false,false,false,false,false,false,false,false,
                               false,false,false,false,false,false,false,false,false,false,
                               false,false,false,false,false,false,false,false,false,false,],
                    search:"",weights:[{value:0 ,label:0},{value:25 ,label:25},{value:50 ,label:50},{value:75 ,label:75},{value:100 ,label:100}],
                    choseweight:"",rtl:false,stayOpen:false,disabled:false,removeSelected:true,invalid:false}
    ...
    render() {
        ...
        <Modal isOpen={this.state.open} toggle={this.toggle} onExit={() => this.clear()}>
                ...
                <Container>
                    <Row>
                        <Col>
                            Project name
                            {console.log(this.state.projectname)}
                            <Input name="projectname" invalid={this.state.invalid} placeholder="Type your project name" onChange={this.handleInputChange}/>
                    ...
                    <Row><Col><Button color="primary" size="lg" block onClick={() => {this.toggle(),this.sendData()}}>Save</Button></Col></Row>
            </Container>
          </ModalBody>
        </Modal>
        </div>
